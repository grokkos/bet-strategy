...
public class CreatorJan2017 {
    public static void main(String[] args) throws SQLException {
        ...
        s.executeUpdate("CREATE TABLE ForebetDaily( "                //Δημιουργία του πίνακα μας
                ...
                + " preOddsPick1x2 VARCHAR(45) NOT NULL,"
                + " aftOddsPick1x2 VARCHAR(45) NOT NULL,"
                ...
                + " preOddsUO VARCHAR(45) NOT NULL,"
                + " aftOddsUO VARCHAR(45) NOT NULL,"
                ...
                + " preOddsHtFt VARCHAR(45) NOT NULL,"
                + " aftOddsHtFt VARCHAR(45) NOT NULL,"
